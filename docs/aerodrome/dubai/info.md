...
## Purpose & Scope
This Standard Operating Procedure (SOP) outlines the procedures, responsibilities, and coordination requirements for Dubai aerodrome operations on the VATSIM network. Its primary goal is to ensure safe, efficient, and standardized handling of IFR and VFR traffic flow into and out of the aerodrome.

This document serves as a reference for both newly certified and experienced controllers operating at Dubai International (OMDB).
...
## Applicability
This SOP is applicable to all VATSIM air traffic controllers operating Dubai at the aerodrome level, including:

- Dubai aerodrome controllers.

...
## Purpose & Scope
This Standard Operating Procedure (SOP) outlines the procedures, responsibilities, and coordination requirements for Muscat aerodrome operations on the VATSIM network. Its primary goal is to ensure safe, efficient, and standardized handling of IFR and VFR traffic flow into and out of the aerodrome.

This document serves as a reference for both newly certified and experienced controllers operating at Muscat International (OOMS).
...
## Applicability
This SOP is applicable to all VATSIM air traffic controllers operating Muscat at the aerodrome level, including:

- Muscat aerodrome controllers.
